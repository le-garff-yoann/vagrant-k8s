...
VAGRANT_K8S_PROVISIONING_STEP=flannel-docker vagrant provision && \
...
VAGRANT_K8S_PROVISIONING_STEP=k8s.traefik1 vagrant provision && \
VAGRANT_K8S_PROVISIONING_STEP=k8s.helm2 vagrant provision
